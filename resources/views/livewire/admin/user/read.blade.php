                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('lastnameP')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'lastnameP') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'lastnameP') fa-sort-amount-up ml-2 @endif'></i> {{ __('LastnameP') }} </th>
                            <th scope="col" style='cursor: pointer' wire:click="sort('lastnameM')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'lastnameM') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'lastnameM') fa-sort-amount-up ml-2 @endif'></i> {{ __('LastnameM') }} </th>
                            <th scope="col" style='cursor: pointer' wire:click="sort('fechaNacimiento')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'fechaNacimiento') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'fechaNacimiento') fa-sort-amount-up ml-2 @endif'></i> {{ __('FechaNacimiento') }} </th>
